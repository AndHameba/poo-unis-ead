package guitarra_java3;

//Declaração da classe
public class Guitarra_java3 {
    private String numeroSerie, fabricante, modelo, tipo, madeira;
    private double preco;
    
    //Criação do construtor da classe
    public Guitarra_java3(
    ...
    public static void main(String[] args){
        ...
        Guitarra_java3 minhaGuitarra = new Guitarra_java3("01020304", "fender", "telecaster", "eletrica", "mogno", 1500);
